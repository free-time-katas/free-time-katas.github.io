---
layout: page
title: "▷ Guía de Git | Aprende todos sus comandos básicos"
description: "En esta guía de Git aprederás como ser un auténtico ➤ ➤ guru. Si aun no has trabajado con este control de versiones, no pierdas más tiempo y pásate al siglo XXI."
principal-title: "Guía de Git. Todo lo que deberías saber. ¿Te atreves?"
principal-image: "/img/git.jpg,Guía de Git"
images-list:
    - /img/proyecto-git.png
    - /img/git-status.png
    ...
    - /img/git-log-5.png
    - /img/git-log-6.png
    - /img/git-status-7.png
    - /img/git-log-7.png
    - /img/git-log-8.png
    - /img/git-status-8.png
    - /img/git-help.png
